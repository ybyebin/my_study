  ...
  methods: {
      ...
      this.pickerIds.forEach((ele, index) => {
        ...
        this.pickerScroll[index].scroll = new this.Scrlll(id, {
          ...
          callback: function(params) {
            let st = that.$store.state.serverTime;
            ...
            if (index === 0) {
              ...
              if (currentIndex === 0) {
                ...
                if (hours > 23) {
                  setTimeout(() => {
                    that.pickerScroll[0].scroll.scrollTo(0, itemHeight, 500);
                    that.pickerScroll[1].scroll.scrollTo(
                      0,
                      itemHeight * 9,
                      500
                    );
                  ...
                  if (minnuteNow < 30) {
                    index3 = 1;
                    setTimeout(() => {
                      that.pickerScroll[2].scroll.scrollTo(0, itemHeight, 500);
                    }, 100);
                  } else {
                    index3 = 1;
                    setTimeout(() => {
                      that.pickerScroll[2].scroll.scrollTo(0, 0, 500);
                    }, 100);
                  }
                }
              } else {
                index2 = 9;
                setTimeout(() => {
                  that.pickerScroll[1].scroll.scrollTo(0, itemHeight * 9, 500);
                }, 100);
              }
            } else if (index === 1) {
              index2 = currentIndex;
    ...
    getServerTime() {
      ...
      this.$https(urls, res => {
        ...
        this.setTimeData(st);
        this.serverTime = st;
        this.units.vuexStoreSet(this, "setServerTime", st);
        this.setPickerId();
      });
    },
